...
export const DayNine = () => {
    ...
    useEffect(() => {
        globalState.lineDays[8].path == "/" ? navigate("/") : null;
    },[globalState.lineDays[8].path])

    return (globalState.lineDays[8].path != "/" && 
        <div className="bg-[url('/img/bg-daynine.webp')] bg-cover bg-center h-screen w-screen flex flex-col justify-between gap-y-20 pb-32 pt-64">
            ...
            <QuotedString str={"Fofinha is my girlfriend! She's my fiancé, actually!"}/>
