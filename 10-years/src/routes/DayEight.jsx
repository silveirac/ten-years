...
export const DayEight = () => {
    ...
    useEffect(() => {
        globalState.lineDays[7].path == "/" ? navigate("/") : null;
    },[globalState.lineDays[7].path])

    return (globalState.lineDays[7].path != "/" && 
        <div className="bg-[url('/img/bg-dayeight.webp')] bg-cover bg-center h-screen w-screen flex flex-col justify-between gap-y-20 pb-32 pt-64">
            ...
            <QuotedString str={"Minha casa é você! É onde você estiver!"}/>
