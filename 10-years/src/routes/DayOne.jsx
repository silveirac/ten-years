...
export const DayOne = () => {
    ...
    useEffect(() => {
        globalState.lineDays[0].path == "/" ? navigate("/") : null;
    },[globalState.lineDays[0].path])

    return (globalState.lineDays[0].path != "/" &&
        <div className="bg-[url('/img/bg-dayone.webp')] bg-cover h-screen w-screen flex flex-col justify-between gap-y-20 pb-32 pt-64">
            ...
            <div className="flex flex-col items-center">
                <h3 className="text-white font-playfare bg-black/30 p-2 rounded-full -mb-4 z-10">Cada dia uma nova surpresa até o nosso dia!</h3>
