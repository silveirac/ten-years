...
const initialState = {
    ...
    lineDays: [
        ...
        {path:"/four", urlPath: "/img/icon-dayfour.svg", soundtrack: "music/four.mp3", stTitle: "Techno Syndrome (Mortal Kombat) - The Immortals"},
        {path:"/five", urlPath: "/img/icon-dayfive.png", soundtrack: "music/five.mp3", stTitle: "We're All In This Together - High School Musical"},
